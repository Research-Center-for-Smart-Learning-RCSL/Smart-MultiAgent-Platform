...
rag_documents = sa.Table(
    ...
    sa.Column("status",
              pg.ENUM("ingesting", "ready", "failed", "quarantined",
                      name="rag_document_status", create_type=False),
              nullable=False,
              server_default=sa.text("'ingesting'::rag_document_status")),
    sa.Column("scan_status",
              pg.ENUM("pending", "clean", "quarantined", "skipped",
                      name="rag_scan_status", create_type=False),
              nullable=False,
