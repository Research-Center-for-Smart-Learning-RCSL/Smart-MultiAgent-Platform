...
it matches §7.4's "in-flight calls complete but no new calls issued" rule
...
SoC: this module knows nothing about `contexts.keys`. Consumers import it
from either side of the boundary without creating a cycle.
"""
