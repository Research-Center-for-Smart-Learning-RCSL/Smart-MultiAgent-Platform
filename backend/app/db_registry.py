...
Moved from ``shared_kernel.db.registry`` -- this module belongs in the app
layer because it imports from every bounded context (a cross-cutting
wiring concern, not shared infrastructure).
"""
...
from contexts.skills.infrastructure import tables as _skills_tables  # noqa: F401
