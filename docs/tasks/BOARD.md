...
- (implemented 2026-09-11) `2026-09-10-canvas-export`. Client-side PNG/SVG
  ...
  lists this slug in `depends_on`, so no row moves out of Blocked.
- (implemented 2026-09-11) `2026-09-10-canvas-templates`. Pre-built canvas templates
  (brainstorming, retrospective, SWOT, mind map), template picker on empty canvas,
  save-as-template for project admins. Migration 0094. AC-1/AC-4 unticked (need
  running stack). Nothing lists this slug in `depends_on`, so no row moves out of
  Blocked.
